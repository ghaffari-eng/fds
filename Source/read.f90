...
REAL(EB) :: EMBER_CONTACT_FRACTION,EMBER_CONTACT_HTC,EMBER_EMISSIVITY,EMBER_GENERATION_HEIGHT(2),&
            EMBER_IGNITION_COEFFS(5),EMBER_IGNITION_FMC,EMBER_IGNITION_POWER_MEAN,EMBER_IGNITION_POWER_SIGMA,&
            EMBER_TRACKING_RATIO,EMBER_YIELD
INTEGER  :: EMBER_IGNITION_TYPE
LOGICAL  :: EMBER_HEAT_TRANSFER
...
NAMELIST /SURF/ ADIABATIC,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,AREA_MULTIPLIER,BACKING,BLOWING,&
                ...
                EMBER_CONTACT_FRACTION,EMBER_CONTACT_HTC,EMBER_EMISSIVITY,EMBER_GENERATION_HEIGHT,&
                EMBER_HEAT_TRANSFER,EMBER_IGNITION_COEFFS,EMBER_IGNITION_FMC,&
                EMBER_IGNITION_POWER_MEAN,EMBER_IGNITION_POWER_SIGMA,EMBER_IGNITION_TYPE,&
                EMBER_TRACKING_RATIO,EMBER_YIELD,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   SF%EMBER_CONTACT_FRACTION = EMBER_CONTACT_FRACTION
   SF%EMBER_CONTACT_HTC = EMBER_CONTACT_HTC
   SF%EMBER_EMISSIVITY = EMBER_EMISSIVITY
   ...
   SF%EMBER_HEAT_TRANSFER = EMBER_HEAT_TRANSFER
   SF%EMBER_IGNITION_COEFFS = EMBER_IGNITION_COEFFS
   SF%EMBER_IGNITION_FMC = EMBER_IGNITION_FMC
   SF%EMBER_IGNITION_POWER_MEAN = EMBER_IGNITION_POWER_MEAN
   SF%EMBER_IGNITION_POWER_SIGMA = EMBER_IGNITION_POWER_SIGMA
   SF%EMBER_IGNITION_TYPE = EMBER_IGNITION_TYPE
...
DUCT_PATH               = 0
E_COEFFICIENT           = 0._EB
EMBER_CONTACT_FRACTION  = 0.5_EB
EMBER_CONTACT_HTC       = 25._EB
EMBER_EMISSIVITY        = 0.9_EB
EMBER_GENERATION_HEIGHT = -1._EB
EMBER_HEAT_TRANSFER     = .FALSE.
EMBER_IGNITION_COEFFS   = (/9.98_EB,-0.263_EB,0.5_EB,0.1_EB,0.005_EB/)
EMBER_IGNITION_FMC      = 10._EB
EMBER_IGNITION_POWER_MEAN = -1._EB
EMBER_IGNITION_POWER_SIGMA = 0.001_EB
EMBER_IGNITION_TYPE     = 0
