...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE,CVODE_ORDER,DA_EXTINCTION, &
                DO_CHEM_LOAD_BALANCE, EQUIV_RATIO_CHECK, &
...
REAL(EB) :: SOOT_YIELD,CO_YIELD,HCN_YIELD,EPUMO2,A,LOWER_OXYGEN_LIMIT, &
            CRITICAL_FLAME_TEMPERATURE,CRITICAL_EXTINCTION_STRAIN_RATE,HEAT_OF_COMBUSTION,HOC_COMPLETE,E,C,H,N,O, &
...
NAMELIST /REAC/ A, A_TROE, A_LOW_PR, &
                ...
                AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_EXTINCTION_STRAIN_RATE, &
                CRITICAL_FLAME_TEMPERATURE,E,E_LOW_PR, &
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   RN%CRITICAL_EXTINCTION_STRAIN_RATE = CRITICAL_EXTINCTION_STRAIN_RATE

   ! Default critical extinction strain rates from counterflow experiments (1/s)
   IF (RN%CRITICAL_EXTINCTION_STRAIN_RATE < TWO_EPSILON_EB .AND. EXTINCT_MOD==EXTINCTION_3) THEN
      SELECT CASE(TRIM(FUEL))
         CASE('METHANE')  ; RN%CRITICAL_EXTINCTION_STRAIN_RATE = 400._EB
         CASE('PROPANE')  ; RN%CRITICAL_EXTINCTION_STRAIN_RATE = 350._EB
         CASE('N-HEPTANE'); RN%CRITICAL_EXTINCTION_STRAIN_RATE = 280._EB
         CASE('ETHANOL')  ; RN%CRITICAL_EXTINCTION_STRAIN_RATE = 300._EB
         CASE('ETHYLENE') ; RN%CRITICAL_EXTINCTION_STRAIN_RATE = 3000._EB
         CASE('HYDROGEN') ; RN%CRITICAL_EXTINCTION_STRAIN_RATE = 8000._EB
         CASE('ACETYLENE'); RN%CRITICAL_EXTINCTION_STRAIN_RATE = 4000._EB
         CASE DEFAULT     ; RN%CRITICAL_EXTINCTION_STRAIN_RATE = 350._EB
      END SELECT
   ENDIF
...
CO_YIELD                    = 0._EB
CRITICAL_EXTINCTION_STRAIN_RATE = 0._EB
