...
INTEGER, PARAMETER :: EXTINCTION_3=3             !< Flag for EXTINCT_MOD (EXTINCTION MODEL 3, PaSR strain-based)
...
REAL(EB) :: DA_EXTINCTION=1._EB                    !< Critical Damkohler number for PaSR extinction model
