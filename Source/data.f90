...
! Strain-based extinction outputs

OUTPUT_QUANTITY(195)%NAME       = 'DAMKOHLER NUMBER'
OUTPUT_QUANTITY(195)%UNITS      = ' '
OUTPUT_QUANTITY(195)%SHORT_NAME = 'Da'

OUTPUT_QUANTITY(196)%NAME       = 'PASR REACTING FRACTION'
OUTPUT_QUANTITY(196)%UNITS      = ' '
OUTPUT_QUANTITY(196)%SHORT_NAME = 'kappa'
